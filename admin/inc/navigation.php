...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <!-- <img src="./Black_and_Red_Modern_Simple_Initial_AD_Letter_Logo__8_-removebg-preview.p" alt="Store Logo" class="brand-image img-circle elevation-3 bg-black" style="width: 1.8rem;height: 1.8rem;max-height: unset"> -->
            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                  ...
                  <!-- recieveing list act as the deals section -->
                    <!-- <li class="nav-item">
