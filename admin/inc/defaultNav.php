  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?php echo base_url ?>index3.html" class="navbar-brand">
        <img src="../uploads/logo1-1635816671.png" alt="Store Logo" class="brand-image img-circle elevation-3 bg-black" style="opacity: .8">
        <span class="brand-text font-weight-light">DataQuantum</span>
      </a>
